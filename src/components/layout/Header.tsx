...
import { Bell, User, Settings as SettingsIcon, LogOut, UserCircle, Shield, Menu } from 'lucide-react';
        ...
        <div className="flex items-center space-x-3 md:space-x-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <p className="hidden md:block text-sm text-gray-500">Northeast India</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex items-center space-x-2 bg-gray-100 rounded-lg p-1">
            ...
            <button
              ...
              className={`px-3 py-1 text-sm font-medium rounded-md transition-colors ${language === 'as'
                ? 'bg-white text-blue-600 shadow-sm'
                : 'text-gray-600 hover:text-gray-900'
                }`}
            >
